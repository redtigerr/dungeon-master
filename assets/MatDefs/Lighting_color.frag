...
void main(){
    ...
    //Team color
    #ifdef KEYCOLOR
        //For changing the team color "sharpness" (brightness)
        #ifdef KEYSTR
            vec4 KeyStrength = vec4(m_KeyStrength);
        #else
            vec4 KeyStrength = vec4(1.0f);
        #endif
        #ifdef KEYMAP
            vec4 KeyMap = texture2D(m_KeyMap, newTexCoord);
        #else
            vec4 KeyMap = vec4(0.1f);
        #endif
        vec4 KeyColor = m_KeyColor * KeyMap * KeyStrength;
    #else
        vec4 KeyColor = vec4(0);
    #endif
    ...
    // ***********************
      ...
      vec4 specularColor = vec4(1.0);
       ...
       gl_FragColor.rgb =  KeyColor         * diffuseColor.rgb  +
